...
| 缩写 | 含义 | 最近检查 |
| ------ | ------ | --------- |
| Win | 仅 Windows 原生 | 2026-07-06 |
| Win -> WSL-1 | Windows 软链接到 WSL-1 | 2026-07-06 |
| WSL-1 | 仅 WSL-1 环境（仅关注 x64 架构） | 2026-07-06 |
| macOS | 仅 macOS（仅关注 arm64 架构） | 2026-08-16 |
...
| ---------------- | ------ | -------- | --------- | -------------- | -------- | ------ |
| ffmpeg | Win¹ | <https://github.com/BtbN/FFmpeg-Builds> | n8.1.2 (2026-06-27) | `ffmpeg.exe -version`（以命令输出为准，不用文件夹名/exiftool） | daily build 2026-07-05² | 🔄 ❌ |
| RenderDoc_1.45_64 | Win | <https://github.com/baldurk/renderdoc> | v1.45 | `exiftool renderdocui.exe \| grep "Product Version"` | v1.45 | ✅ |
| scrcpy | Win 安装, WSL-1 链接 | <https://github.com/Genymobile/scrcpy> | 4.0 | `scrcpy --version` | v4.0 | ✅ |
| jadx-gui-1.5.5 | Win 安装, WSL-1 链接 | <https://github.com/skylot/jadx> | 1.5.5 | `exiftool jadx-gui.exe \| grep "Product Version"` | v1.5.5 | ✅ |
| draw.io | Win | <https://github.com/jgraph/drawio-desktop> | 30.2.6 | `exiftool draw.io.exe \| grep "Product Version"` | v30.2.6 | ✅ |
| mpv-x86_64-v3 | Win 安装, WSL-1 链接 | <https://github.com/zhongfly/mpv-winbuild> | v0.41.0-821-g62f149466 (2026-06-27) | `mpv --version`（以命令输出为准，不用文件夹名） | daily build 2026-07-06² | 🔄 ❌ |
| YUView-Win | Win | <https://github.com/IENT/YUView> | v2.14-322 | `grep "Last Commit" YUView-Win/versioninfo.txt` | v2.14 | ✅ |
...
| WinDirStat.exe | Win | <https://github.com/windirstat/windirstat> | 2.7.0 | `exiftool WinDirStat.exe \| grep "Product Version"` | v2.7.0 | ✅ |
...
| Snipaste | Win | <https://www.snipaste.com/download.html> | 2.11.2³ | `exiftool Snipaste.exe \| grep "Product Version"` | 见官网³ | ⏸️ |
| WSL | Win | <https://github.com/microsoft/WSL> | 2.7.10 | `cmd.exe /c wsl --version` | 2.7.10 | ✅ |
| git | Win | <https://github.com/git-for-windows/git> | 2.54.0 | `cmd.exe /c git --version` | v2.55.0.windows.2 | ❌ |
...
| 软件 / 条目 | 平台 | 参考 URL | 本地版本 | 查本地版本方法 | 最新版本 | 是否最新 |
| ---------------- | ------ | -------- | --------- | -------------- | -------- | ------ |
| scrcpy | WSL-1（Win 安装） | <https://github.com/Genymobile/scrcpy> | 4.0 | `scrcpy --version` | v4.0 | ✅ |
| jadx-gui-1.5.5 | WSL-1（Win 安装） | <https://github.com/skylot/jadx> | 1.5.5 | `exiftool jadx-gui.exe \| grep "Product Version"` | v1.5.5 | ✅ |
| mpv-x86_64-v3 | WSL-1（Win 安装） | <https://github.com/zhongfly/mpv-winbuild> | v0.41.0-821-g62f149466 (2026-06-27) | `mpv --version`（以命令输出为准，不用文件夹名） | daily build 2026-07-06² | 🔄 ❌ |
| ffmpeg | WSL-1¹ | <https://github.com/BtbN/FFmpeg-Builds> | n8.1.2 (2026-06-27) | `ffmpeg -version`（以命令输出为准，不用文件夹名） | daily build 2026-07-05² | 🔄 ❌ |
| git | WSL-1 | <https://github.com/git/git> | 2.54.0 | `git --version` | v2.55.0 | ❌ |
| yt-dlp | WSL-1 | <https://github.com/yt-dlp/yt-dlp> | 2026.07.04 | `yt-dlp --version` | 2026.07.04 | ✅ |
...
| fastfetch¹¹ | WSL-1 | <https://github.com/fastfetch-cli/fastfetch> | 2.65.1 | `fastfetch --version` | 2.65.2 | 🔨 ❌ |
| gh | WSL-1 | <https://github.com/cli/cli> | 2.96.0 | `gh --version` | v2.96.0 | ✅ |
...
| Stats | macOS | <https://github.com/exelban/stats> | 3.0.10 | `defaults read /Applications/Stats.app/Contents/Info.plist CFBundleShortVersionString` | v3.0.11 | ❌ |
...
| macOS (系统) | macOS | <https://support.apple.com/zh-cn/109033> | 15.7.8 | `sw_vers` | 15.7.8 (Sequoia)⁸ | ✅ |
| Android Studio⁴ | macOS | <https://developer.android.google.cn/studio/releases> | 2025.3 (AI-253.32098.37.2534.15232325) | `python3 -c "import json;print(json.load(open('/Applications/Android Studio.app/Contents/Resources/product-info.json'))['version'])"` | 2026.1.3 (Quail 3) | ❌ |
| CC Switch | macOS | <https://github.com/farion1231/cc-switch> | 3.19.2 | `defaults read "/Applications/CC Switch.app/Contents/Info.plist" CFBundleShortVersionString` | v3.19.2 | ✅ |
| AltTab | macOS | <https://github.com/lwouis/alt-tab-macos> | 11.4.4 | `defaults read /Applications/AltTab.app/Contents/Info.plist CFBundleShortVersionString` | v11.4.4 | ✅ |
...
| Notepad-- | macOS | <https://github.com/cxasm/notepad--> | 3.8.2 | `defaults read /Applications/Notepad--.app/Contents/Info.plist CFBundleShortVersionString` | v3.8.2 | ✅ |
| Ollama | macOS | <https://github.com/ollama/ollama> | 0.32.13 | `defaults read /Applications/Ollama.app/Contents/Info.plist CFBundleShortVersionString` | v0.32.13 | ✅ |
| gh | macOS | <https://github.com/cli/cli> | 2.97.0 | `gh --version` | v2.97.0 | ✅ |
...
> ³ Snipaste 无开源源码仓库，参考 URL 为官网下载页；exe 有可能已被原地替换升级，文件夹名仍为旧版本。最新版本需手动访问官网确认，无法自动查询，"是否最新"标记为 ⏸️（需人工检查）。 <br/>
...
共 53 个软件条目（不含 apt / Homebrew 包列表；含 3 条跨平台重复——draw.io、gh、checksec 在 Win/WSL-1 与 macOS 间重复；macOS 系统版本作为独立条目计入），40 个 GitHub 仓库（跨平台条目共享同一仓库时去重；Snipaste、Android Studio、macOS、Process Explorer、Source Insight 等闭源/非 GitHub 来源不计入）。
